    ...
    { profile && <div>
      ...
      <>
        ...
        <div className="details">
          ...
          <div className="profile-created-at">Fecha de creación: {new Date(profile.createdAt).toDateString()}</div>
        </div>
      </> }
      ...
      { posts.length>0 && <div className="post-section">
        { posts.length>0 && <span className="all-posts-title">Post realizados por mi:</span> }
